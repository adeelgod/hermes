...
@XmlRootElement(name = "process_log")
public class ProcessLog extends DirectBean
{
    @PropertyDefinition
    ...
    ///CLOVER:OFF
    /**
     * The meta-bean for {@code ProcessLog}.
     * @return the meta-bean, not null
     */
    public static ProcessLog.Meta meta() {
        return ProcessLog.Meta.INSTANCE;
    }

    static {
        JodaBeanUtils.registerMetaBean(ProcessLog.Meta.INSTANCE);
    }

    @Override
    public ProcessLog.Meta metaBean() {
        return ProcessLog.Meta.INSTANCE;
    }
    ...
    public static class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<String> invoiceId = DirectMetaProperty.ofReadWrite(
                this, "invoiceId", ProcessLog.class, String.class);
        /**
        ...
        private final MetaProperty<String> shippingId = DirectMetaProperty.ofReadWrite(
                this, "shippingId", ProcessLog.class, String.class);
        /**
        ...
        private final MetaProperty<Date> processedAt = DirectMetaProperty.ofReadWrite(
                this, "processedAt", ProcessLog.class, Date.class);
        /**
        ...
        private final MetaProperty<String> productType = DirectMetaProperty.ofReadWrite(
                this, "productType", ProcessLog.class, String.class);
        /**
         * The meta-properties.
         */
        ...
        @Override
        public BeanBuilder<? extends ProcessLog> builder() {
            return new DirectBeanBuilder<ProcessLog>(new ProcessLog());
        }

        @Override
        public Class<? extends ProcessLog> beanType() {
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case 115792:  // uid
                    return ((ProcessLog) bean).getUid();
                case -1361632588:  // charge
                    return ((ProcessLog) bean).getCharge();
                case -1207110391:  // orderId
                    return ((ProcessLog) bean).getOrderId();
                case -840527425:  // unitId
                    return ((ProcessLog) bean).getUnitId();
                case -1739442904:  // invoiceId
                    return ((ProcessLog) bean).getInvoiceId();
                case 2113549161:  // shippingId
                    return ((ProcessLog) bean).getShippingId();
                case 203012129:  // processedAt
                    return ((ProcessLog) bean).getProcessedAt();
                case -1491615543:  // productType
                    return ((ProcessLog) bean).getProductType();
            }
        ...
        protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
            switch (propertyName.hashCode()) {
                case 115792:  // uid
                    ((ProcessLog) bean).setUid((String) newValue);
                    return;
                case -1361632588:  // charge
                    ((ProcessLog) bean).setCharge((String) newValue);
                    return;
                case -1207110391:  // orderId
                    ((ProcessLog) bean).setOrderId((String) newValue);
                    return;
                case -840527425:  // unitId
                    ((ProcessLog) bean).setUnitId((String) newValue);
                    return;
                case -1739442904:  // invoiceId
                    ((ProcessLog) bean).setInvoiceId((String) newValue);
                    return;
                case 2113549161:  // shippingId
                    ((ProcessLog) bean).setShippingId((String) newValue);
                    return;
                case 203012129:  // processedAt
                    ((ProcessLog) bean).setProcessedAt((Date) newValue);
                    return;
                case -1491615543:  // productType
                    ((ProcessLog) bean).setProductType((String) newValue);
                    return;
            }
