...
public class BankStatement extends DirectBean
{
     ...
     * @return the property, not null
     */
    public final Property<Double> amountDiff() {
    ...
    /**
     * Sets the ignore.
     * @param ignore  the new value of the property
     */
    ...
    /**
     * Gets the the {@code ignore} property.
     * @return the property, not null
     */
    public final Property<Boolean> ignore() {
        return metaBean().ignore().createProperty(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass() == this.getClass()) {
            ...
            return JodaBeanUtils.equal(getId(), other.getId()) &&
                    ...
                    JodaBeanUtils.equal(getIgnore(), other.getIgnore());
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        hash = hash * 31 + JodaBeanUtils.hashCode(getIgnore());
        return hash;
    }
    ...
    protected void toString(StringBuilder buf) {
        ...
        buf.append("ignore").append('=').append(JodaBeanUtils.toString(getIgnore())).append(',').append(' ');
    }
    ...
    public static class Meta extends DirectMetaBean {
         ...
         */
        private final MetaProperty<Double> amountDiff = DirectMetaProperty.ofReadWrite(
                this, "amountDiff", BankStatement.class, Double.class);
        /**
        ...
        /**
         * The meta-property for the {@code ignore} property.
         */
        private final MetaProperty<Boolean> ignore = DirectMetaProperty.ofReadWrite(
                this, "ignore", BankStatement.class, Boolean.class);
        /**
         * The meta-properties.
         */
         ...
         * @return the meta-property, not null
         */
        public final MetaProperty<Double> amountDiff() {
            return amountDiff;
        }
         ...
         * @return the meta-property, not null
         */
        public final MetaProperty<Boolean> ignore() {
            return ignore;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                ...
                case -1190396462:  // ignore
                    return ((BankStatement) bean).getIgnore();
            }
        ...
        protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
            switch (propertyName.hashCode()) {
                ...
                case -1413853096:  // amount
                    ...
                    return;
                case -1425349507:  // amountDiff
                    ((BankStatement) bean).setAmountDiff((Double) newValue);
                    return;
                case 575402001:  // currency
                ...
                case -804109473:  // confirmed
                    ...
                    return;
                case -1190396462:  // ignore
                    ((BankStatement) bean).setIgnore((Boolean) newValue);
                    return;
            }
