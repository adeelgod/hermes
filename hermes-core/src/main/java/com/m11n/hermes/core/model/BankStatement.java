...
public class BankStatement extends DirectBean
{
    ...
    /**
     * Sets the ignored.
     * @param ignored  the new value of the property
     */
    ...
    /**
     * Gets the the {@code ignored} property.
     * @return the property, not null
     */
    public final Property<Boolean> ignored() {
        return metaBean().ignored().createProperty(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass() == this.getClass()) {
            ...
            return JodaBeanUtils.equal(getId(), other.getId()) &&
                    ...
                    JodaBeanUtils.equal(getIgnored(), other.getIgnored());
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        hash = hash * 31 + JodaBeanUtils.hashCode(getIgnored());
        return hash;
    }
    ...
    protected void toString(StringBuilder buf) {
        ...
        buf.append("ignored").append('=').append(JodaBeanUtils.toString(getIgnored())).append(',').append(' ');
    }
    ...
    public static class Meta extends DirectMetaBean {
        ...
        /**
         * The meta-property for the {@code ignored} property.
         */
        private final MetaProperty<Boolean> ignored = DirectMetaProperty.ofReadWrite(
                this, "ignored", BankStatement.class, Boolean.class);
        /**
         * The meta-properties.
         */
         ...
         * @return the meta-property, not null
         */
        public final MetaProperty<Boolean> ignored() {
            return ignored;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                ...
                case 1752415442:  // ignored
                    return ((BankStatement) bean).getIgnored();
            }
        ...
        protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
            switch (propertyName.hashCode()) {
                ...
                case -804109473:  // confirmed
                    ...
                    return;
                case 1752415442:  // ignored
                    ((BankStatement) bean).setIgnored((Boolean) newValue);
                    return;
            }
