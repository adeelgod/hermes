...
public class BankStatement extends DirectBean
{
     ...
     * @return the property, not null
     */
    public final Property<Double> matching() {
    ...
    public static class Meta extends DirectMetaBean {
         ...
         */
        private final MetaProperty<Double> matching = DirectMetaProperty.ofReadWrite(
                this, "matching", BankStatement.class, Double.class);
        /**
         * The meta-properties.
         */
         ...
         * @return the meta-property, not null
         */
        public final MetaProperty<Double> matching() {
            return matching;
        }
        ...
        protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
            switch (propertyName.hashCode()) {
                ...
                case -892481550:  // status
                    ...
                    return;
                case 296922109:  // matching
                    ((BankStatement) bean).setMatching((Double) newValue);
                    return;
            }
