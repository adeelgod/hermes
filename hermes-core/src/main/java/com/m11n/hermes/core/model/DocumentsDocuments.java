...
public class DocumentsDocuments extends DirectBean {
    ...
    @PropertyDefinition
    @JsonSerialize(include = JsonSerialize.Inclusion.NON_NULL)
    @Column(name = "times_printed")
    private Integer timesPrinted;
    ...
    /**
     * Sets the timesPrinted.
     * @param timesPrinted  the new value of the property
     */
    public void setTimesPrinted(Integer timesPrinted) {
        this.timesPrinted = timesPrinted;
    }

    /**
     * Gets the the {@code timesPrinted} property.
     * @return the property, not null
     */
    public final Property<Integer> timesPrinted() {
        return metaBean().timesPrinted().createProperty(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass() == this.getClass()) {
            ...
            return JodaBeanUtils.equal(getId(), other.getId()) &&
                    ...
                    JodaBeanUtils.equal(getTimesPrinted(), other.getTimesPrinted());
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        hash = hash * 31 + JodaBeanUtils.hashCode(getTimesPrinted());
        return hash;
    }
    ...
    protected void toString(StringBuilder buf) {
        ...
        buf.append("timesPrinted").append('=').append(JodaBeanUtils.toString(getTimesPrinted())).append(',').append(' ');
    }
    ...
    public static class Meta extends DirectMetaBean {
        ...
        /**
         * The meta-property for the {@code timesPrinted} property.
         */
        private final MetaProperty<Integer> timesPrinted = DirectMetaProperty.ofReadWrite(
                this, "timesPrinted", DocumentsDocuments.class, Integer.class);
        /**
         * The meta-properties.
         */
         ...
         * @return the meta-property, not null
         */
        public final MetaProperty<Integer> timesPrinted() {
            return timesPrinted;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                ...
                case 187612646:  // timesPrinted
                    return ((DocumentsDocuments) bean).getTimesPrinted();
            }
        ...
        protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
            switch (propertyName.hashCode()) {
                ...
                case -391500408:  // pathPrint
                    ...
                    return;
                case 187612646:  // timesPrinted
                    ((DocumentsDocuments) bean).setTimesPrinted((Integer) newValue);
                    return;
            }
