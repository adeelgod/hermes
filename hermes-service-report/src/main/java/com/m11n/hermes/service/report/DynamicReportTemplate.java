...
public class DynamicReportTemplate {
    ...
    static {
        ...
        HyperLinkBuilder link = hyperLink("http://www.l-carb-shop.de/");
        dynamicReportsComponent =
                cmp.horizontalList(
                        //cmp.image(DynamicReportTemplate.class.getClassLoader().getResource("images/dynamicreports.png")).setFixedDimension(60, 60),
                        cmp.verticalList(
                                cmp.text("Low Carb Shop").setStyle(bold22CenteredStyle).setHorizontalAlignment(HorizontalAlignment.LEFT),
                                cmp.text("http://www.l-carb-shop.de/").setStyle(italicStyle).setHyperLink(link))).setFixedWidth(300);
