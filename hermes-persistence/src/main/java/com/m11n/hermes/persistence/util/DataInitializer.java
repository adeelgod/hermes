...
public class DataInitializer {
    ...
    public void init() {
        Form form = new Form();
        form.setName("orders");
        form.setSqlStatement("SELECT order_id as \"orderId\", Bestellung as \"invoiceId\", shipping_lable as \"shippingId\" FROM mage_custom_order WHERE Status = \"complete\" and Datum_Lieferung > :from and Datum_Lieferung < :until");
